    ...
    return (
        ...
        <div className="md:w-[250px] w-full h-fit py-2 flex flex-col shadow border rounded">
            ...
            <div className="w-full flex flex-col items-center justify-center mt-2">
                <CImage src="/barber/1.jpg" className="w-[120px] h-[120px] rounded-full " alt="profile" />
                <h4 className="mt-2">User Name</h4>
                <span className="text-sm text-gray-400 mt-1">detail profile user</span>
            </div>
            ...
            <div className="w-full border-t px-4 py-3 flex flex-col">
                ...
                <div className="w-full h-[7px] rounded-xl bg-gray-300 mt-2 shadow overflow-hidden flex items-center ">
                    <div className="w-[75%] bg-fresh-25 h-[5px] rounded-xl" />
                </div>
            </div>
